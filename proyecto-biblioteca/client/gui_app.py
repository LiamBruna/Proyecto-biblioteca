...
class Frame(tk.Frame):
    ...
    def loginWindow(self):
        ...
        show_password_checkbox = ck.CTkCheckBox(self, text_color="black", text="Mostrar contraseña", variable=self.show_password, command=self.toggle_password_visibility)
