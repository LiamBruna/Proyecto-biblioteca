...
class VentanaRegistro(ck.CTkToplevel):
    def __init__(self, parent=None):
        ...
        label_log = ck.CTkLabel(master=frame_registro, text="Registrarse", font=ck.CTkFont(size=30, weight="bold", family="Segoe UI"))
        label_log.place(x=170, y=30)

        # Crea los campos de entrada de datos para el registro
        self.nombre_entry = ck.CTkEntry(frame_registro, placeholder_text='Nombre (*)', width=220, height=40, font=ck.CTkFont(size=15, weight="bold", family="Segoe UI"))
        self.nombre_entry.place(x=90, y=80)

        self.apellido_entry = ck.CTkEntry(frame_registro, placeholder_text='Apellido (*)', width=220, height=40, font=ck.CTkFont(size=15, weight="bold", family="Segoe UI"))
        self.apellido_entry.place(x=90, y=130)

        self.rut_entry = ck.CTkEntry(frame_registro, placeholder_text='RUT (con puntos y guión)', width=220, height=40, font=ck.CTkFont(size=15, weight="bold", family="Segoe UI"))
        self.rut_entry.place(x=90, y=180)

        self.correo_entry = ck.CTkEntry(frame_registro, placeholder_text='Correo electrónico (*)', width=220, height=40, font=ck.CTkFont(size=15, weight="bold", family="Segoe UI"))
        self.correo_entry.place(x=90, y=230)

        self.codigo_pais_entry = ck.CTkEntry(frame_registro, textvariable=self.codigo_pais, width=60, height=40, font=ck.CTkFont(size=15, weight="bold", family="Segoe UI"), state="disabled")
        self.codigo_pais_entry.place(x=90, y=280)

        self.celular_entry = ck.CTkEntry(frame_registro, placeholder_text='N° de Celular (*)', textvariable=self.celular, width=150, height=40, font=ck.CTkFont(size=15, weight="bold", family="Segoe UI"))
        self.celular_entry.place(x=160, y=280)

        self.contraseña_entry = ck.CTkEntry(frame_registro, placeholder_text='Contraseña', width=220, height=40, show="*",font=ck.CTkFont(size=15, weight="bold", family="Segoe UI"))
        self.contraseña_entry.place(x=90, y=330)

        self.contraseña_entry_confirmar = ck.CTkEntry(frame_registro, placeholder_text='Confirmar Contraseña', width=220, height=40, show="*", font=ck.CTkFont(size=15, weight="bold", family="Segoe UI"))
        ...
        mostrar_contraseña_checkbox = ck.CTkCheckBox(frame_registro, text="Mostrar contraseña", variable=self.mostrarContraseña_Registro, command=self.mostrarContraseñaRegistro, font=ck.CTkFont(size=15, weight="bold", family="Segoe UI"))
        mostrar_contraseña_checkbox.place(x=320, y=388)

        self.registro_photo = ck.CTkImage(Image.open("img\\registro.ico"), size=(30,30))

        # Botón para registrarse
        button_registrar = ck.CTkButton(frame_registro, width=200, text="Registrarse", command=self.registrar, image=self.registro_photo, font=ck.CTkFont(size=20, weight="bold", family="Segoe UI"))
        button_registrar.place(x=100, y=430)

        self.volver_button = ck.CTkButton(master = frame_registro, command=self.volverLogin, text="Volver", font=ck.CTkFont(size=15, weight="bold", family="Segoe UI"))
...
class Frame(ck.CTkFrame):
    def __init__(self, root=None):
        ...
        label_log = ck.CTkLabel(master=frame, text="Iniciar Sesión", font=ck.CTkFont(size=30, weight="bold", family="Segoe UI"))
        label_log.place(x=60, y=40)

        self.correo = ck.CTkEntry(master=frame, placeholder_text='Correo electrónico', width=220, height=40, font=ck.CTkFont(size=15, weight="bold", family="Segoe UI"))
        self.correo.place(x=50, y=80)

        self.contraseña = tk.StringVar()
        self.contraseña_entry = ck.CTkEntry(master=frame, placeholder_text='Contraseña', width=220, height=40, show="*", font=ck.CTkFont(size=15, weight="bold", family="Segoe UI"))
        ...
        self.checkbox_mostrar_contraseña = ck.CTkCheckBox(master=frame, text="Mostrar contraseña", variable=self.mostrar_contraseña, command=self.mostrarContraseña, font=ck.CTkFont(size=15, weight="bold", family="Segoe UI"))
        ...
        self.button_login = ck.CTkButton(master=frame, text="Iniciar sesión", command=self.login, image=iniciar_sesion_photo, font=ck.CTkFont(size=18, weight="bold", family="Segoe UI"))
        self.button_login.place(x=80, y=220)

        registrarse_photo = ck.CTkImage(Image.open("img\\registrarse.ico"), size=(25, 25))
        self.button_registrar = ck.CTkButton(master=frame, text="Registrarse", command=self.abrir_ventana_registro, image=registrarse_photo, font=ck.CTkFont(size=18, weight="bold", family="Segoe UI"))
        self.button_registrar.place(x=86, y=270)

        self.button_olvido_contraseña = ck.CTkButton(master=frame, text="¿Olvidó su contraseña?", font=ck.CTkFont(size=18, weight="bold", family="Segoe UI"), command=self.abrir_ventana_recuperar_contraseña)
...
class VentanaPrincipal(ck.CTkToplevel):
    def __init__(self, parent, correo_actual = None):
        ...
        self.frameNavegacion_label = ck.CTkLabel(self.frameNavegacion, text="  Biblioteca Virtual", image=self.logo_imagen,
                                                  compound="left", font=ck.CTkFont(size=30, weight="bold", family="Segoe UI"))
        ...
        self.inicio_button = ck.CTkButton(self.frameNavegacion, corner_radius=0, height=40, border_spacing=10, text="Inicio",
                                        ...
                                        command=self.inicio_button_evento, font=ck.CTkFont(size=20, weight="bold", family="Segoe UI"))
        ...
        self.catalogo_button = ck.CTkButton(self.frameNavegacion, corner_radius=0, height=40, border_spacing=10, text="Catalogo",
                                        ...
                                        command=self.catalogo_button_evento, font=ck.CTkFont(size=20, weight="bold", family="Segoe UI"))
        ...
        self.stock_button = ck.CTkButton(self.frameNavegacion, corner_radius=0, height=40, border_spacing=10, text="Actualizar Stock",
                                         ...
                                         command=self.stock_button_evento, font=ck.CTkFont(size=20, weight="bold", family="Segoe UI"))
        ...
        self.usuario_button = ck.CTkButton(self.frameNavegacion, corner_radius=0, height=40, border_spacing=10, text="Usuarios Registrados",
                                           ...
                                           image=self.usuario_image, anchor="w",command=self.usuario_button_evento, font=ck.CTkFont(size=20, weight="bold", family="Segoe UI"))
        ...
        self.realizar_prestamo_button = ck.CTkButton(self.frameNavegacion, corner_radius=0, height=40, border_spacing=10,
                                           ...
                                           command=self.realizarPrestamo_button_evento, font=ck.CTkFont(size=20, weight="bold", family="Segoe UI"))
        ...
        self.frame_libros_en_prestamo_button = ck.CTkButton(self.frameNavegacion, corner_radius=0, height=40, border_spacing=10,
                                           ...
                                           command=self.frame_libros_en_prestamo_button_evento, font=ck.CTkFont(size=20, weight="bold", family="Segoe UI"))
        ...
        self.menu_apariencia = ck.CTkOptionMenu(self.frameNavegacion, font=ck.CTkFont(size=15, weight="bold", family="Segoe UI"), values=["Dark", "Light"], command=self.evento_cambiar_apariencia)
        self.menu_apariencia.grid(row=10, column=0, padx=20, pady=20, sticky="s")

        # Botón para cerrar sesion
        self.button_cerrarSesion = ck.CTkButton(self.frameNavegacion, font=ck.CTkFont(size=18, weight="bold", family="Segoe UI"), text="Cerrar sesión", image=self.cerrar_sesion_imagen, command=self.cerrar_sesion)
        ...
        self.actualizar_button = ck.CTkButton(self.inicio_frame, text='ACTUALIZAR TABLA', font=ck.CTkFont(size=15, weight="bold", family="Segoe UI"), command=self.mostrarDatosPrestamo)
        ...
        self.categoria = ttk.Combobox(self.catalogo, values=categorias, font=ck.CTkFont(size=20, weight="bold", family="Segoe UI"))
        ...
        self.buscar_nombre_libro_entry = ck.CTkEntry(self.catalogo, placeholder_text="Con mayus y minus", width=200, font=ck.CTkFont(size=20, weight="bold", family="Segoe UI"))
        ...
        self.buscar_isbn_libro_entry = ck.CTkEntry(self.catalogo, placeholder_text="Ej: l-001", width=100, font=ck.CTkFont(size=20, weight="bold", family="Segoe UI"))
        ...
        self.mostar_libros_button = ck.CTkButton(self.catalogo, text="MOSTRAR TODOS LOS LIBROS",
                                                font=ck.CTkFont(size=13, weight="bold", family="Segoe UI"),
        ...
        self.buscar_libro_isbn_entry = ck.CTkEntry(self.stock, width=140, textvariable=self.buscar_actualiza, font=ck.CTkFont(size=20, weight="bold", family="Segoe UI"))
        ...
        self.buscar_libro_isbn_button = ck.CTkButton(self.stock, command=self.buscarLibroStock, text="BUSCAR", font=ck.CTkFont(size=20, weight="bold", family="Segoe UI"))
        ...
        self.isbn_entry = ck.CTkEntry(self.stock, width=140, textvariable=self.isbn, font=ck.CTkFont(size=20, weight="bold", family="Segoe UI"), state="disabled")
        ...
        self.titulo_entry = ck.CTkEntry(self.stock, width=200, textvariable=self.titulo, font=ck.CTkFont(size=20, weight="bold", family="Segoe UI"), state="disabled")
        ...
        self.numero_paginas_entry = ck.CTkEntry(self.stock, width=140, textvariable=self.numero_paginas, font=ck.CTkFont(size=20, weight="bold", family="Segoe UI"), state="disabled")
        ...
        self.stock_entry = ck.CTkEntry(self.stock, width=140, textvariable=self.stockLibro, font=ck.CTkFont(size=20, weight="bold", family="Segoe UI"))
        ...
        self.actualizar_stock_button = ck.CTkButton(self.stock, command=self.actualizarStock, text="ACTUALIZAR", font=ck.CTkFont(size=20, weight="bold", family="Segoe UI"))
        ...
        self.actualizar_button = ck.CTkButton(self.usuario, text='ACTUALIZAR TABLA', font=ck.CTkFont(size=15, weight="bold", family="Segoe UI"), command=self.mostrarDatosUsuario)
        self.actualizar_button.grid(columnspan=1, row=2, pady=5)
        ...
        self.rut_usuario_entry = ck.CTkEntry(self.frame_realizar_prestamo, textvariable=self.rut_usuario, width=140, font=ck.CTkFont(size=20, weight="bold", family="Segoe UI"))
        ...
        self.buscar_usuario_rut = ck.CTkButton(self.frame_realizar_prestamo, command=self.obtenerTipoUsuario, text="BUSCAR", font=ck.CTkFont(size=20, weight="bold", family="Segoe UI"))
        ...
        self.isbn_libro_entry = ck.CTkEntry(self.frame_realizar_prestamo, textvariable=self.isbn, width=140, font=ck.CTkFont(size=20, weight="bold", family="Segoe UI"))
        ...
        self.tipo_usuario_entry = ck.CTkEntry(self.frame_realizar_prestamo, textvariable=self.tipo_usuario, width=140, font=ck.CTkFont(size=20, weight="bold", family="Segoe UI"))
        ...
        self.agregar_libro_button = ck.CTkButton(self.frame_realizar_prestamo, command=self.agregarLibro, text="Agregar", font=ck.CTkFont(size=20, weight="bold", family="Segoe UI"))
        self.agregar_libro_button.grid(row=16, column=0, pady=5)

        #Botón que eliminará el libro de la tabla
        self.eliminar_libro_button = ck.CTkButton(self.frame_realizar_prestamo, command=self.eliminarLibro, text="Eliminar", font=ck.CTkFont(size=20, weight="bold", family="Segoe UI"))
        self.eliminar_libro_button.grid(row=16, column=1, pady=5)

        # Botón que realizara el préstamo
        self.completar_prestamo_button = ck.CTkButton(self.frame_realizar_prestamo, command=self.realizarPrestamo, text="REALIZAR PRÉSTAMO", font=ck.CTkFont(size=20, weight="bold", family="Segoe UI"))
        ...
        actualizar_librosPrestamo_button = ck.CTkButton(self.frame_libros_en_prestamo, text='ACTUALIZAR TABLA LIBROS EN PRÉSTAMO', font=ck.CTkFont(size=15, weight="bold", family="Segoe UI"), command=self.mostrarDatosLibros)
    ...
    def actualizarStock(self, event = None):
        ...
        self.barra_progreso_label = ck.CTkLabel(self.stock, text="",
                                                font=ck.CTkFont(size=14, weight="bold", family="Segoe UI"))
    ...
    def crear_imagen_flip(self, imagen_bytes, titulo, detalle):
        ...
        imagen_label = ck.CTkLabel(self.canvas, text="", image=imagen, font=ck.CTkFont(size=20, weight="bold", family="Segoe UI"), text_color="black")
